...
CREATE or ALTER PROCEDURE usp_insertPhoneRecord(
	-- input parameters
	@phoneId numeric(2),
	@phoneNum numeric(10),
	@empId INTEGER,
...
CREATE CLUSTERED INDEX CIX_EMPLOYEE_TEST_EMP_TEST_ID
ON EMPLOYEE_TEST(EMP_TEST_ID)
GO

SELECT * FROM EMPLOYEE_TEST2
GO

CREATE NONCLUSTERED INDEX CIX_EMPLOYEE_TEST2_EMP_TEST_ID
ON EMPLOYEE_TEST2(EMP_TEST_ID)
GO